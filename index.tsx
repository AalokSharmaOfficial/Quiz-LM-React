...
import { FiSettings, FiArchive, FiTag, FiRefreshCw, FiHelpCircle, FiZoomIn, FiZoomOut, FiMenu, FiChevronsRight, FiX, FiCheck, FiStar, FiFlag, FiMaximize, FiMinimize, FiClock, FiChevronDown, FiTrendingUp, FiCheckSquare, FiTarget } from 'react-icons/fi';
...
function ScoreSection({
  quizQuestions, userAnswers, onPlayAgain, onReviewAnswers, onReviewIncorrect, onShare
}: {
  ...
  const { correct, incorrect, unanswered, attempted } = useMemo(() => {
    ...
    quizQuestions.forEach(q => {
      ...
      if (answer && answer !== 'SKIPPED' && answer !== 'TIME_UP') {
        attempted++;
        if (answer === q.correct) {
          correct++;
        } else {
  ...
  let title = '';
  if (score > 80) title = "Quiz Master!";
  else if (score > 50) title = "Great Effort!";
      ...
      <div className="score-breakdown">
        ...
        <div className="attempt-details">
          ...
          <div className="attempt-legend">
            <ul>
              <li><span className="legend-dot correct"></span>Correct<span className="legend-value">{correct}</span></li>
              <li><span className="legend-dot incorrect"></span>Incorrect<span className="legend-value">{incorrect}</span></li>
              <li><span className="legend-dot unanswered"></span>Unanswered<span className="legend-value">{unanswered}</span></li>
            </ul>
            <button 
